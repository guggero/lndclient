...
func (s *signerClient) MuSig2CreateSession(ctx context.Context,
	...
	*input.MuSig2SessionInfo, error) {
	...
	var rpcMuSig2Version signrpc.MuSig2Version
	...
	case input.MuSig2Version040:
		rpcMuSig2Version = signrpc.MuSig2Version_MUSIG2_VERSION_V040

	case input.MuSig2Version100RC2:
		rpcMuSig2Version = signrpc.MuSig2Version_MUSIG2_VERSION_V100RC2

	default:
		return nil, fmt.Errorf("invalid MuSig2 version")
	}
